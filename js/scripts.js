...
upDateValue(type, value){
    ...
    switch(type){
        ...
        break;
        case "vertical" : this.verticalRef.value=value; break;
        case "blur" : this.blurRef.value=value; break;
...
const boxShadow=new BoxShadowGenerated(horizontal, horizontalRef, vertical, verticalRef, blur, blurRef, spread, spreadRef, previewBox, rule, webkitRule, mozRule);
